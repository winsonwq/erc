...
class Img extends M(Basic, EditMode) {
  ...
  renderContent() {
    ...
    const { srcFieldLabel, altFieldLabel, imgPlaceholderSrc } = this.props;
    ...
    return <img className="erc-image" src={ data.src || imgPlaceholderSrc } alt={ data.alt } />;
  }
...
Img.propTypes = {
  ...
  imgPlaceholderSrc: React.PropTypes.string
};
